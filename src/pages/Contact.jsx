    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <a href="mailto:Vishal@amirrafinwaye.com" className="bg-white shadow-xl rounded-xl p-8 border-l-4 border-[#D4A537] hover:shadow-2xl hover:scale-105 transition-all duration-500">
